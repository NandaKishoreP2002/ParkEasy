        ...
        <div>
            ...
            <div className='container'>
                <div className='row py-5 my-5'>
                    ...
                    <p>"Park Easy helps people find and rent out parking spaces in their community. If you have an extra parking spot, you can make some extra money by renting it out. And if you need an affordable place to park, we'll help you find one!"</p>
                </div>
                ...
                <div className='row mt-5 mb-5'>
                    ...
                    <div className='col-md-6 d-flex align-items-center'>
                        <div>
                            ...
                            <p>The Park Easy web application offers a convenient solution for individuals in search of parking. With this user-friendly platform, users can effortlessly search for parking spaces that match their preferences. Once they've identified a suitable spot, they can reserve it by completing the payment process. After confirmation, users will receive instructions on how to park their vehicles, ensuring a hassle-free and efficient parking experience that meets their specific needs.</p>
                        </div>
                    </div>
                </div>
